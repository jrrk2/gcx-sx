...
static inline int is_string_delim(char c) {return (c == '\'') || (c=='"');}
static inline int is_name_char(char c) {return (isalnum(c)) || (c=='_');}
static inline int is_number_char(char c) {return (isdigit(c) || (c) == '.' ||
					      (c) == 'e' || (c) == 'E'); }
static inline int is_number_start(char c) {return (isdigit(c) || c == '-'); }

...
create_pstar (void)
{
  ...
  pstar = gtk_window_new (GTK_WINDOW_DIALOG);
  ...
  label4 = gtk_label_new ("Epoch:");
  gtk_widget_ref (label4);
  gtk_object_set_data_full (GTK_OBJECT (pstar), "label4", label4,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  epoch_entry = gtk_entry_new ();
  gtk_widget_ref (epoch_entry);
  gtk_object_set_data_full (GTK_OBJECT (pstar), "epoch_entry", epoch_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (epoch_entry);
  gtk_table_attach (GTK_TABLE (table1), epoch_entry, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 1);
...
create_camera_control (void)
{
  ...
  GList *img_bin_combo_items = NULL;
  GtkWidget *img_bin_combo_entry;
  ...
  GtkWidget *obs_filter_combo_entry;
  ...
  GtkWidget *vbox8;
  GtkWidget *table7;
  GtkWidget *cameras_combo;
  GtkWidget *cameras_combo_entry;
  GtkWidget *cam_find_button;
  GtkWidget *label31;
  GtkWidget *table8;
  GtkWidget *label32;
  GtkWidget *label33;
  ...
  GtkWidget *cooler_power_entry;
  GtkWidget *table24;
  GtkWidget *fwheel_combo;
  GtkWidget *fwheel_combo_entry;
  GtkWidget *fwheel_find_button;
  GtkWidget *label91;
  GtkWidget *label13;
  GtkWidget *vbox24;
  GtkWidget *table22;
  ...
  GtkWidget *scope_align_button;
  GtkWidget *scope_dither_button;
  GtkWidget *label86;
  GtkWidget *cam_status;
  GtkTooltips *tooltips;
  ...
  gtk_table_attach (GTK_TABLE (table2), img_bin_combo, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  img_bin_combo_items = g_list_append (img_bin_combo_items, (gpointer) "1x1");
  img_bin_combo_items = g_list_append (img_bin_combo_items, (gpointer) "2x2");
  img_bin_combo_items = g_list_append (img_bin_combo_items, (gpointer) "3x3");
  img_bin_combo_items = g_list_append (img_bin_combo_items, (gpointer) "4x4");
  gtk_combo_set_popdown_strings (GTK_COMBO (img_bin_combo), img_bin_combo_items);
  g_list_free (img_bin_combo_items);

  img_bin_combo_entry = GTK_COMBO (img_bin_combo)->entry;
  gtk_widget_ref (img_bin_combo_entry);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "img_bin_combo_entry", img_bin_combo_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (img_bin_combo_entry);
  gtk_widget_set_usize (img_bin_combo_entry, 100, -2);
  gtk_entry_set_text (GTK_ENTRY (img_bin_combo_entry), "1x1");

  img_exp_spin_adj = gtk_adjustment_new (1, 0, 3600, 1, 10, 10);
  ...
  img_width_spin_adj = gtk_adjustment_new (1, 0, 100, 10, 10, 10);
  ...
  img_height_spin_adj = gtk_adjustment_new (1, 0, 100, 10, 10, 10);
  ...
  img_x_skip_spin_adj = gtk_adjustment_new (1, 0, 100, 1, 10, 10);
  ...
  img_y_skip_spin_adj = gtk_adjustment_new (1, 0, 100, 1, 10, 10);
  ...
  obs_filter_combo = gtk_combo_new ();
  ...
  obs_filter_combo_entry = GTK_COMBO (obs_filter_combo)->entry;
  gtk_widget_ref (obs_filter_combo_entry);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "obs_filter_combo_entry", obs_filter_combo_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (obs_filter_combo_entry);
  ...
  file_seqn_spin_adj = gtk_adjustment_new (1, 0, 100, 1, 10, 10);
  ...
  img_number_spin_adj = gtk_adjustment_new (2, 1, 100, 1, 10, 10);
  ...
  cameras_combo = gtk_combo_new ();
  gtk_widget_ref (cameras_combo);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "cameras_combo", cameras_combo,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (cameras_combo);
  gtk_table_attach (GTK_TABLE (table7), cameras_combo, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  cameras_combo_entry = GTK_COMBO (cameras_combo)->entry;
  gtk_widget_ref (cameras_combo_entry);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "cameras_combo_entry", cameras_combo_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (cameras_combo_entry);

  cam_find_button = gtk_button_new_with_label (" Find ");
  gtk_widget_ref (cam_find_button);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "cam_find_button", cam_find_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (cam_find_button);
  gtk_table_attach (GTK_TABLE (table7), cam_find_button, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_widget_set_sensitive (cam_find_button, FALSE);
  gtk_tooltips_set_tip (tooltips, cam_find_button, "Locate cameras on network", NULL);

  label31 = gtk_label_new ("Camera  [cx://<host>/<imager>]");
  gtk_widget_ref (label31);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "label31", label31,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_misc_set_padding (GTK_MISC (label31), 0, 2);
  ...
  label34 = gtk_label_new ("Current power");
  gtk_widget_ref (label34);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "label34", label34,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label34);
  gtk_table_attach (GTK_TABLE (table8), label34, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label34), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label34), 3, 0);

  cooler_tempset_spin_adj = gtk_adjustment_new (-35, -50, 30, 5, 10, 10);
  ...
  cooler_power_entry = gtk_entry_new ();
  gtk_widget_ref (cooler_power_entry);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "cooler_power_entry", cooler_power_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (cooler_power_entry);
  gtk_table_attach (GTK_TABLE (table8), cooler_power_entry, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_editable (GTK_ENTRY (cooler_power_entry), FALSE);
  ...
  fwheel_combo = gtk_combo_new ();
  gtk_widget_ref (fwheel_combo);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "fwheel_combo", fwheel_combo,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (fwheel_combo);
  gtk_table_attach (GTK_TABLE (table24), fwheel_combo, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  fwheel_combo_entry = GTK_COMBO (fwheel_combo)->entry;
  gtk_widget_ref (fwheel_combo_entry);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "fwheel_combo_entry", fwheel_combo_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (fwheel_combo_entry);

  fwheel_find_button = gtk_button_new_with_label (" Find ");
  gtk_widget_ref (fwheel_find_button);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "fwheel_find_button", fwheel_find_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (fwheel_find_button);
  gtk_table_attach (GTK_TABLE (table24), fwheel_find_button, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_widget_set_sensitive (fwheel_find_button, FALSE);
  gtk_tooltips_set_tip (tooltips, fwheel_find_button, "Locate cameras on network", NULL);

  label91 = gtk_label_new ("Filter wheel:  [fwheel://<host>/<port>]");
  gtk_widget_ref (label91);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "label91", label91,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label91);
  gtk_table_attach (GTK_TABLE (table24), label91, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label91), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label91), 0, 2);
  ...
  e_limit_spin_adj = gtk_adjustment_new (1, -6, 2, 0.5, 10, 10);
  ...
  w_limit_spin_adj = gtk_adjustment_new (1, -2, 6, 0.5, 10, 10);
  ...
  s_limit_spin_adj = gtk_adjustment_new (-45, -90, 90, 1, 10, 10);
  ...
  n_limit_spin_adj = gtk_adjustment_new (80, -90, 90, 1, 10, 10);
  ...
  scope_align_button = gtk_button_new_with_label ("Align");
  gtk_widget_ref (scope_align_button);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "scope_align_button", scope_align_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (scope_align_button);
  gtk_container_add (GTK_CONTAINER (hbuttonbox13), scope_align_button);
  GTK_WIDGET_SET_FLAGS (scope_align_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, scope_align_button, "Tell telescope to align using the given obs coordinates", NULL);
  ...
  cam_status = gtk_statusbar_new ();
  gtk_widget_ref (cam_status);
  gtk_object_set_data_full (GTK_OBJECT (camera_control), "cam_status", cam_status,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (cam_status);
  gtk_box_pack_start (GTK_BOX (vbox3), cam_status, FALSE, FALSE, 0);
...
create_wcs_edit (void)
{
  ...
  wcs_edit = gtk_window_new (GTK_WINDOW_DIALOG);
  ...
  label40 = gtk_label_new ("Epoch of coordinates");
...
GtkWidget*
create_create_recipy (void)
{
  GtkWidget *create_recipy;
  GtkWidget *vbox16;
  GtkWidget *table13;
  ...
  create_recipy = gtk_window_new (GTK_WINDOW_DIALOG);
  gtk_object_set_data (GTK_OBJECT (create_recipy), "create_recipy", create_recipy);
  gtk_window_set_title (GTK_WINDOW (create_recipy), "Create Recipy");
  gtk_window_set_position (GTK_WINDOW (create_recipy), GTK_WIN_POS_CENTER);

  vbox16 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox16);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "vbox16", vbox16,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox16);
  gtk_container_add (GTK_CONTAINER (create_recipy), vbox16);
  gtk_container_set_border_width (GTK_CONTAINER (vbox16), 3);

  table13 = gtk_table_new (15, 2, FALSE);
  gtk_widget_ref (table13);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "table13", table13,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "var_checkb", var_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "field_checkb", field_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "user_checkb", user_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "det_checkb", det_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "label49", label49,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "convuser_checkb", convuser_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "convdet_checkb", convdet_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "convfield_checkb", convfield_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "std_checkb", std_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "convcat_checkb", convcat_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "catalog_checkb", catalog_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "label97", label97,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "label98", label98,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "label50", label50,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "tgt_entry", tgt_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (tgt_entry);
  gtk_table_attach (GTK_TABLE (table13), tgt_entry, 0, 2, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_tooltips_set_tip (tooltips, tgt_entry, "The name of the object that is the main target of the recipy, to be set in the recipy header", NULL);

  seq_entry = gtk_entry_new ();
  gtk_widget_ref (seq_entry);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "seq_entry", seq_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "comments_entry", comments_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (comments_entry);
  gtk_table_attach (GTK_TABLE (table13), comments_entry, 0, 2, 7, 8,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_tooltips_set_tip (tooltips, comments_entry, "Recipy comments", NULL);

  hbox25 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox25);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "hbox25", hbox25,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  recipy_file_entry = gtk_entry_new ();
  gtk_widget_ref (recipy_file_entry);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "recipy_file_entry", recipy_file_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (recipy_file_entry);
  gtk_box_pack_start (GTK_BOX (hbox25), recipy_file_entry, TRUE, TRUE, 0);
  gtk_tooltips_set_tip (tooltips, recipy_file_entry, "Recipy file name", NULL);

  browse_file_button = gtk_button_new_with_label (" ... ");
  gtk_widget_ref (browse_file_button);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "browse_file_button", browse_file_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "off_frame_checkb", off_frame_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (off_frame_checkb);
  gtk_table_attach (GTK_TABLE (table13), off_frame_checkb, 1, 2, 8, 9,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_tooltips_set_tip (tooltips, off_frame_checkb, "If this option is cleared, stars outside the frame area are not included in the recipy", NULL);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (off_frame_checkb), TRUE);

  hseparator3 = gtk_hseparator_new ();
  gtk_widget_ref (hseparator3);
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "hseparator3", hseparator3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "hbuttonbox9", hbuttonbox9,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "mkrcp_ok_button", mkrcp_ok_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (create_recipy), "mkrcp_close_button", mkrcp_close_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_widget_grab_focus (recipy_file_entry);
  gtk_widget_grab_default (mkrcp_ok_button);
  gtk_object_set_data (GTK_OBJECT (create_recipy), "tooltips", tooltips);

  return create_recipy;
}
...
create_yes_no (void)
{
  ...
  yes_no = gtk_window_new (GTK_WINDOW_DIALOG);
...
create_phot_run (void)
{
  ...
  phot_run = gtk_window_new (GTK_WINDOW_DIALOG);
  gtk_object_set_data (GTK_OBJECT (phot_run), "phot_run", phot_run);
  gtk_window_set_title (GTK_WINDOW (phot_run), "Photometry Run");

  vbox18 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox18);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "vbox18", vbox18,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox18);
  gtk_container_add (GTK_CONTAINER (phot_run), vbox18);

  notebook2 = gtk_notebook_new ();
  gtk_widget_ref (notebook2);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "notebook2", notebook2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (notebook2);
  gtk_box_pack_start (GTK_BOX (vbox18), notebook2, TRUE, TRUE, 0);

  table15 = gtk_table_new (8, 2, TRUE);
  gtk_widget_ref (table15);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "table15", table15,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  hbox11 = gtk_hbox_new (FALSE, 3);
  gtk_widget_ref (hbox11);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "hbox11", hbox11,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox11);
  gtk_table_attach (GTK_TABLE (table15), hbox11, 1, 2, 5, 6,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 3, 0);

  radiobutton1 = gtk_radio_button_new_with_label (coltype_group, "Standard");
  coltype_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton1));
  gtk_widget_ref (radiobutton1);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton1", radiobutton1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton1);
  gtk_box_pack_start (GTK_BOX (hbox11), radiobutton1, FALSE, FALSE, 0);

  radiobutton2 = gtk_radio_button_new_with_label (coltype_group, "Instrumental");
  coltype_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton2));
  gtk_widget_ref (radiobutton2);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton2", radiobutton2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "entry7", entry7,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry7);
  gtk_table_attach (GTK_TABLE (table15), entry7, 0, 1, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  entry6 = gtk_entry_new ();
  gtk_widget_ref (entry6);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "entry6", entry6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry6);
  gtk_table_attach (GTK_TABLE (table15), entry6, 0, 1, 5, 6,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  entry5 = gtk_entry_new ();
  gtk_widget_ref (entry5);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "entry5", entry5,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry5);
  gtk_table_attach (GTK_TABLE (table15), entry5, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  entry4 = gtk_entry_new ();
  gtk_widget_ref (entry4);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "entry4", entry4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry4);
  gtk_table_attach (GTK_TABLE (table15), entry4, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  checkbutton12 = gtk_check_button_new_with_label ("Enable color transform");
  gtk_widget_ref (checkbutton12);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "checkbutton12", checkbutton12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton12);
  gtk_table_attach (GTK_TABLE (table15), checkbutton12, 1, 2, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 3, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton12), TRUE);

  label59 = gtk_label_new ("Instrumental Band");
  gtk_widget_ref (label59);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label59", label59,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label59);
  gtk_table_attach (GTK_TABLE (table15), label59, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label59), 0, 1);

  label60 = gtk_label_new ("Standard band");
  gtk_widget_ref (label60);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label60", label60,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label60);
  gtk_table_attach (GTK_TABLE (table15), label60, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label60), 0, 1);

  label61 = gtk_label_new ("Color Index");
  gtk_widget_ref (label61);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label61", label61,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label61);
  gtk_table_attach (GTK_TABLE (table15), label61, 0, 1, 4, 5,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label61), 0, 1);

  label62 = gtk_label_new ("Color coefficient");
  gtk_widget_ref (label62);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label62", label62,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label62);
  gtk_table_attach (GTK_TABLE (table15), label62, 0, 1, 6, 7,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label62), 0, 1);

  label53 = gtk_label_new ("Bands");
  gtk_widget_ref (label53);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label53", label53,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label53);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 0), label53);

  table16 = gtk_table_new (8, 2, TRUE);
  gtk_widget_ref (table16);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "table16", table16,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table16);
  gtk_container_add (GTK_CONTAINER (notebook2), table16);
  gtk_container_set_border_width (GTK_CONTAINER (table16), 3);

  label63 = gtk_label_new ("Radius of central aperture (R1)");
  gtk_widget_ref (label63);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label63", label63,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label63);
  gtk_table_attach (GTK_TABLE (table16), label63, 0, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label63), 0, 1);

  label67 = gtk_label_new ("Inner radius of sky annulus (R2)");
  gtk_widget_ref (label67);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label67", label67,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label67);
  gtk_table_attach (GTK_TABLE (table16), label67, 0, 2, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label67), 0, 1);

  label68 = gtk_label_new ("Outer radius of sky annulus (R3)");
  gtk_widget_ref (label68);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label68", label68,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label68);
  gtk_table_attach (GTK_TABLE (table16), label68, 0, 2, 4, 5,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label68), 0, 1);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton11", spinbutton11,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton11);
  gtk_table_attach (GTK_TABLE (table16), spinbutton11, 0, 1, 5, 6,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton10", spinbutton10,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton10);
  gtk_table_attach (GTK_TABLE (table16), spinbutton10, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton9", spinbutton9,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton9);
  gtk_table_attach (GTK_TABLE (table16), spinbutton9, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton12", spinbutton12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton12);
  gtk_table_attach (GTK_TABLE (table16), spinbutton12, 0, 1, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  label69 = gtk_label_new ("Maximum position change when centering apertures");
  gtk_widget_ref (label69);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label69", label69,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label69);
  gtk_table_attach (GTK_TABLE (table16), label69, 0, 2, 6, 7,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label69), 0, 1);

  checkbutton13 = gtk_check_button_new_with_label ("Center apertures");
  gtk_widget_ref (checkbutton13);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "checkbutton13", checkbutton13,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton13);
  gtk_table_attach (GTK_TABLE (table16), checkbutton13, 1, 2, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 3, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton13), TRUE);

  label54 = gtk_label_new ("Apertures");
  gtk_widget_ref (label54);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label54", label54,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label54);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 1), label54);

  table17 = gtk_table_new (6, 3, TRUE);
  gtk_widget_ref (table17);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "table17", table17,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table17);
  gtk_container_add (GTK_CONTAINER (notebook2), table17);
  gtk_container_set_border_width (GTK_CONTAINER (table17), 3);

  radiobutton4 = gtk_radio_button_new_with_label (skymet_group, "Mean");
  skymet_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton4));
  gtk_widget_ref (radiobutton4);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton4", radiobutton4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton4);
  gtk_table_attach (GTK_TABLE (table17), radiobutton4, 2, 3, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  radiobutton5 = gtk_radio_button_new_with_label (skymet_group, "Median");
  skymet_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton5));
  gtk_widget_ref (radiobutton5);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton5", radiobutton5,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton5);
  gtk_table_attach (GTK_TABLE (table17), radiobutton5, 2, 3, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  radiobutton6 = gtk_radio_button_new_with_label (skymet_group, "Kappa-Sigma");
  skymet_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton6));
  gtk_widget_ref (radiobutton6);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton6", radiobutton6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton6);
  gtk_table_attach (GTK_TABLE (table17), radiobutton6, 2, 3, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  radiobutton7 = gtk_radio_button_new_with_label (skymet_group, "Mean-Median");
  skymet_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton7));
  gtk_widget_ref (radiobutton7);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton7", radiobutton7,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton7);
  gtk_table_attach (GTK_TABLE (table17), radiobutton7, 2, 3, 4, 5,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  radiobutton8 = gtk_radio_button_new_with_label (skymet_group, "Synthetic Mode");
  skymet_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton8));
  gtk_widget_ref (radiobutton8);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "radiobutton8", radiobutton8,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton8);
  gtk_table_attach (GTK_TABLE (table17), radiobutton8, 2, 3, 5, 6,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  label71 = gtk_label_new ("Maximum iterations");
  gtk_widget_ref (label71);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label71", label71,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label71);
  gtk_table_attach (GTK_TABLE (table17), label71, 0, 2, 4, 5,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label71), 0, 1);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton13", spinbutton13,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton13);
  gtk_table_attach (GTK_TABLE (table17), spinbutton13, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton14", spinbutton14,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton14);
  gtk_table_attach (GTK_TABLE (table17), spinbutton14, 0, 1, 5, 6,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  label70 = gtk_label_new ("Acceptance band for k-s and mmode");
  gtk_widget_ref (label70);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label70", label70,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label70);
  gtk_table_attach (GTK_TABLE (table17), label70, 0, 2, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label70), 0, 1);

  label77 = gtk_label_new ("Method:");
  gtk_widget_ref (label77);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label77", label77,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label77);
  gtk_table_attach (GTK_TABLE (table17), label77, 2, 3, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label77), 1.86265e-07, 0.5);
  gtk_misc_set_padding (GTK_MISC (label77), 4, 0);

  label55 = gtk_label_new ("Sky Estimation");
  gtk_widget_ref (label55);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label55", label55,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label55);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 2), label55);

  table18 = gtk_table_new (6, 2, TRUE);
  gtk_widget_ref (table18);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "table18", table18,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table18);
  gtk_container_add (GTK_CONTAINER (notebook2), table18);
  gtk_container_set_border_width (GTK_CONTAINER (table18), 3);

  label75 = gtk_label_new ("Iteration limit");
  gtk_widget_ref (label75);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label75", label75,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label75);
  gtk_table_attach (GTK_TABLE (table18), label75, 0, 1, 4, 5,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label75), 0, 1);

  label73 = gtk_label_new ("Alpha robust fitting parameter (half-width of weight function)");
  gtk_widget_ref (label73);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label73", label73,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label73);
  gtk_table_attach (GTK_TABLE (table18), label73, 0, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label73), 0, 1);

  label74 = gtk_label_new ("Beta robust fitting parameter (slope of weight function)");
  gtk_widget_ref (label74);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label74", label74,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label74);
  gtk_table_attach (GTK_TABLE (table18), label74, 0, 2, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label74), 0, 1);

  spinbutton15_adj = gtk_adjustment_new (2, 0, 10, 0.5, 10, 10);
  spinbutton15 = gtk_spin_button_new (GTK_ADJUSTMENT (spinbutton15_adj), 1, 1);
  gtk_widget_ref (spinbutton15);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton15", spinbutton15,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton15);
  gtk_table_attach (GTK_TABLE (table18), spinbutton15, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  spinbutton16_adj = gtk_adjustment_new (1, 0, 10, 0.5, 10, 10);
  spinbutton16 = gtk_spin_button_new (GTK_ADJUSTMENT (spinbutton16_adj), 1, 1);
  gtk_widget_ref (spinbutton16);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton16", spinbutton16,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton16);
  gtk_table_attach (GTK_TABLE (table18), spinbutton16, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (spinbutton16), TRUE);
  ...
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "spinbutton17", spinbutton17,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton17);
  gtk_table_attach (GTK_TABLE (table18), spinbutton17, 0, 1, 5, 6,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  label72 = gtk_label_new ("Fit");
  gtk_widget_ref (label72);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label72", label72,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label72);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 3), label72);

  empty_notebook_page = gtk_vbox_new (FALSE, 0);
  gtk_widget_show (empty_notebook_page);
  gtk_container_add (GTK_CONTAINER (notebook2), empty_notebook_page);

  label76 = gtk_label_new ("Report");
  gtk_widget_ref (label76);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "label76", label76,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label76);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook2), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook2), 4), label76);

  hbuttonbox11 = gtk_hbutton_box_new ();
  gtk_widget_ref (hbuttonbox11);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "hbuttonbox11", hbuttonbox11,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbuttonbox11);
  gtk_box_pack_start (GTK_BOX (vbox18), hbuttonbox11, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (hbuttonbox11), 6);
  gtk_button_box_set_spacing (GTK_BUTTON_BOX (hbuttonbox11), 15);

  button10 = gtk_button_new_with_label ("Run");
  gtk_widget_ref (button10);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "button10", button10,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button10);
  gtk_container_add (GTK_CONTAINER (hbuttonbox11), button10);
  GTK_WIDGET_SET_FLAGS (button10, GTK_CAN_DEFAULT);

  button11 = gtk_button_new_with_label ("Save");
  gtk_widget_ref (button11);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "button11", button11,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button11);
  gtk_container_add (GTK_CONTAINER (hbuttonbox11), button11);
  GTK_WIDGET_SET_FLAGS (button11, GTK_CAN_DEFAULT);

  button12 = gtk_button_new_with_label ("Reload ");
  gtk_widget_ref (button12);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "button12", button12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button12);
  gtk_container_add (GTK_CONTAINER (hbuttonbox11), button12);
  GTK_WIDGET_SET_FLAGS (button12, GTK_CAN_DEFAULT);

  button13 = gtk_button_new_with_label ("Close");
  gtk_widget_ref (button13);
  gtk_object_set_data_full (GTK_OBJECT (phot_run), "button13", button13,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button13);
  gtk_container_add (GTK_CONTAINER (hbuttonbox11), button13);
...
create_image_processing (void)
{
  ...
  guint imf_add_button_key;
  GtkWidget *imf_add_button;
  guint imf_rm_button_key;
  GtkWidget *imf_rm_button;
  guint imf_display_button_key;
  GtkWidget *imf_display_button;
  guint imf_next_button_key;
  GtkWidget *imf_next_button;
  guint imf_skip_button_key;
  GtkWidget *imf_skip_button;
  guint imf_unskip_button_key;
  GtkWidget *imf_unskip_button;
  guint imf_select_all_key;
  GtkWidget *imf_select_all;
  guint imf_reload_button_key;
  GtkWidget *imf_reload_button;
  ...
  GtkWidget *table23;
  GtkWidget *align_scale_checkb;
  GtkWidget *align_rotate_checkb;
  GtkWidget *frame10;
  GtkWidget *hbox22;
  ...
  guint run_button_key;
  GtkWidget *run_button;
  guint abort_button_key;
  ...
  gtk_window_set_default_size (GTK_WINDOW (image_processing), 400, 300);
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "hbox12", hbox12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox12);
  gtk_box_pack_start (GTK_BOX (vbox19), hbox12, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox12), scrolledwindow, TRUE, TRUE, 0);
  gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (scrolledwindow), GTK_POLICY_AUTOMATIC, GTK_POLICY_ALWAYS);

  viewport3 = gtk_viewport_new (NULL, NULL);
  gtk_widget_ref (viewport3);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "viewport3", viewport3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (viewport3);
  gtk_container_add (GTK_CONTAINER (scrolledwindow), viewport3);
  ...
  gtk_container_add (GTK_CONTAINER (viewport3), image_file_list);
  gtk_list_set_selection_mode (GTK_LIST (image_file_list), GTK_SELECTION_EXTENDED);

  vbox20 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox20);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "vbox20", vbox20,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox20);
  gtk_box_pack_start (GTK_BOX (hbox12), vbox20, FALSE, FALSE, 0);

  vbuttonbox1 = gtk_vbutton_box_new ();
  gtk_widget_ref (vbuttonbox1);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "vbuttonbox1", vbuttonbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbuttonbox1);
  gtk_box_pack_start (GTK_BOX (vbox20), vbuttonbox1, TRUE, TRUE, 0);
  gtk_button_box_set_layout (GTK_BUTTON_BOX (vbuttonbox1), GTK_BUTTONBOX_START);
  gtk_button_box_set_spacing (GTK_BUTTON_BOX (vbuttonbox1), 0);
  gtk_button_box_set_child_size (GTK_BUTTON_BOX (vbuttonbox1), 0, 12);
  gtk_button_box_set_child_ipadding (GTK_BUTTON_BOX (vbuttonbox1), 14, 0);

  imf_add_button = gtk_button_new_with_label ("");
  imf_add_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_add_button)->child),
                                   "_Add");
  gtk_widget_add_accelerator (imf_add_button, "clicked", accel_group,
                              imf_add_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_add_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_add_button", imf_add_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_add_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_add_button);
  GTK_WIDGET_SET_FLAGS (imf_add_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_add_button, "Add a FITS file to the list", NULL);

  imf_rm_button = gtk_button_new_with_label ("");
  imf_rm_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_rm_button)->child),
                                   "_Remove");
  gtk_widget_add_accelerator (imf_rm_button, "clicked", accel_group,
                              imf_rm_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_rm_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_rm_button", imf_rm_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_rm_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_rm_button);
  GTK_WIDGET_SET_FLAGS (imf_rm_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_rm_button, "Remove selected frames from the list", NULL);

  imf_display_button = gtk_button_new_with_label ("");
  imf_display_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_display_button)->child),
                                   "_Display");
  gtk_widget_add_accelerator (imf_display_button, "clicked", accel_group,
                              imf_display_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_display_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_display_button", imf_display_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_display_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_display_button);
  GTK_WIDGET_SET_FLAGS (imf_display_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_display_button, "Display selected file", NULL);

  imf_next_button = gtk_button_new_with_label ("");
  imf_next_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_next_button)->child),
                                   "_Next");
  gtk_widget_add_accelerator (imf_next_button, "clicked", accel_group,
                              imf_next_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_next_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_next_button", imf_next_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_next_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_next_button);
  GTK_WIDGET_SET_FLAGS (imf_next_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_next_button, "Select and display next frame", NULL);

  imf_skip_button = gtk_button_new_with_label ("");
  imf_skip_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_skip_button)->child),
                                   "_Skip");
  gtk_widget_add_accelerator (imf_skip_button, "clicked", accel_group,
                              imf_skip_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_skip_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_skip_button", imf_skip_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_skip_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_skip_button);
  GTK_WIDGET_SET_FLAGS (imf_skip_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_skip_button, "Mark frame to be skipped, and display next", NULL);

  imf_unskip_button = gtk_button_new_with_label ("");
  imf_unskip_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_unskip_button)->child),
                                   "_Unskip");
  gtk_widget_add_accelerator (imf_unskip_button, "clicked", accel_group,
                              imf_unskip_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_unskip_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_unskip_button", imf_unskip_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_unskip_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_unskip_button);
  GTK_WIDGET_SET_FLAGS (imf_unskip_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_unskip_button, "Remove skip marking", NULL);

  imf_select_all = gtk_button_new_with_label ("");
  imf_select_all_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_select_all)->child),
                                   "Se_lect all");
  gtk_widget_add_accelerator (imf_select_all, "clicked", accel_group,
                              imf_select_all_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_select_all);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_select_all", imf_select_all,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_select_all);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_select_all);
  GTK_WIDGET_SET_FLAGS (imf_select_all, GTK_CAN_DEFAULT);

  imf_reload_button = gtk_button_new_with_label ("");
  imf_reload_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (imf_reload_button)->child),
                                   "R_eload");
  gtk_widget_add_accelerator (imf_reload_button, "clicked", accel_group,
                              imf_reload_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (imf_reload_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "imf_reload_button", imf_reload_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (imf_reload_button);
  gtk_container_add (GTK_CONTAINER (vbuttonbox1), imf_reload_button);
  GTK_WIDGET_SET_FLAGS (imf_reload_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, imf_reload_button, "Reload selected files", NULL);
  ...
  gtk_box_pack_start (GTK_BOX (vbox19), imf_info_label, FALSE, TRUE, 0);
  gtk_label_set_justify (GTK_LABEL (imf_info_label), GTK_JUSTIFY_LEFT);
  gtk_label_set_line_wrap (GTK_LABEL (imf_info_label), TRUE);
  gtk_misc_set_alignment (GTK_MISC (imf_info_label), 7.45058e-09, 0.5);
  gtk_misc_set_padding (GTK_MISC (imf_info_label), 0, 3);

  label79 = gtk_label_new ("Image Files");
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "vbox21", vbox21,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox21);
  gtk_container_add (GTK_CONTAINER (notebook3), vbox21);

  frame2 = gtk_frame_new ("Bias subtraction");
  gtk_widget_ref (frame2);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "frame2", frame2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame2);
  gtk_box_pack_start (GTK_BOX (vbox21), frame2, FALSE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox21), frame3, FALSE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox21), frame4, FALSE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox21), frame5, FALSE, TRUE, 0);
  ...
  gtk_widget_set_sensitive (badpix_entry, FALSE);
  gtk_tooltips_set_tip (tooltips, badpix_entry, "bad pixel map file name", NULL);

  badbix_browse = gtk_button_new_with_label (" ... ");
  gtk_widget_ref (badbix_browse);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "badbix_browse", badbix_browse,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (badbix_browse);
  gtk_box_pack_start (GTK_BOX (hbox17), badbix_browse, FALSE, FALSE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (badbix_browse), 2);
  gtk_widget_set_sensitive (badbix_browse, FALSE);
  gtk_tooltips_set_tip (tooltips, badbix_browse, "Browse", NULL);
  ...
  gtk_widget_set_sensitive (badpix_checkb, FALSE);
  ...
  gtk_box_pack_start (GTK_BOX (vbox21), frame7, FALSE, TRUE, 0);
  ...
  mul_spin_adj = gtk_adjustment_new (1, 0, 100, 0.1, 10, 10);
  ...
  add_spin_adj = gtk_adjustment_new (0, -10000, 10000, 1, 10, 10);
  ...
  label80 = gtk_label_new ("CCD Reduction");
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "vbox26", vbox26,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox26);
  gtk_container_add (GTK_CONTAINER (notebook3), vbox26);

  frame6 = gtk_frame_new ("Alignment reference");
  gtk_widget_ref (frame6);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "frame6", frame6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame6);
  gtk_box_pack_start (GTK_BOX (vbox26), frame6, FALSE, TRUE, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "table23", table23,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table23);
  gtk_box_pack_start (GTK_BOX (vbox26), table23, TRUE, TRUE, 0);

  align_scale_checkb = gtk_check_button_new_with_label ("Enable image scaling");
  gtk_widget_ref (align_scale_checkb);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "align_scale_checkb", align_scale_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (align_scale_checkb);
  gtk_table_attach (GTK_TABLE (table23), align_scale_checkb, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_widget_set_sensitive (align_scale_checkb, FALSE);

  align_rotate_checkb = gtk_check_button_new_with_label ("Enable image rotation");
  gtk_widget_ref (align_rotate_checkb);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "align_rotate_checkb", align_rotate_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (align_rotate_checkb);
  gtk_table_attach (GTK_TABLE (table23), align_rotate_checkb, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_widget_set_sensitive (align_rotate_checkb, FALSE);
  ...
  gtk_table_attach (GTK_TABLE (table23), frame10, 0, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  ...
  blur_spin_adj = gtk_adjustment_new (0.5, 0, 50, 0.1, 10, 10);
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "hbuttonbox15", hbuttonbox15,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbuttonbox15);
  gtk_box_pack_start (GTK_BOX (vbox26), hbuttonbox15, FALSE, TRUE, 0);

  show_align_button = gtk_button_new_with_label ("Show Alignment Stars");
  gtk_widget_ref (show_align_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "show_align_button", show_align_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (show_align_button);
  gtk_container_add (GTK_CONTAINER (hbuttonbox15), show_align_button);
  GTK_WIDGET_SET_FLAGS (show_align_button, GTK_CAN_DEFAULT);

  label89 = gtk_label_new ("Alignment");
  gtk_widget_ref (label89);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "label89", label89,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label89);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook3), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook3), 2), label89);

  vbox22 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox22);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "vbox22", vbox22,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox22);
  gtk_container_add (GTK_CONTAINER (notebook3), vbox22);

  frame8 = gtk_frame_new ("Stacking Algorithm");
  gtk_widget_ref (frame8);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "frame8", frame8,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame8);
  gtk_box_pack_start (GTK_BOX (vbox22), frame8, FALSE, FALSE, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "table19", table19,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table19);
  gtk_box_pack_start (GTK_BOX (hbox20), table19, TRUE, TRUE, 3);
  gtk_table_set_col_spacings (GTK_TABLE (table19), 20);

  stack_sigmas_spin_adj = gtk_adjustment_new (10, 0.5, 10, 0.25, 10, 10);
  ...
  gtk_table_attach (GTK_TABLE (table19), stack_iter_spin, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table19), label83, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table19), label82, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table19), stack_method_optmenu, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  stack_checkb = gtk_check_button_new_with_label ("Enable stacking");
  ...
  gtk_table_attach (GTK_TABLE (table19), stack_checkb, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_tooltips_set_tip (tooltips, stack_checkb, "Enable frame stacking", NULL);

  frame9 = gtk_frame_new ("Background Matching");
  gtk_widget_ref (frame9);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "frame9", frame9,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame9);
  gtk_box_pack_start (GTK_BOX (vbox22), frame9, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame9), 3);

  hbox21 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox21);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "hbox21", hbox21,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox21);
  gtk_container_add (GTK_CONTAINER (frame9), hbox21);

  table20 = gtk_table_new (2, 2, TRUE);
  gtk_widget_ref (table20);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "table20", table20,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table20);
  gtk_box_pack_start (GTK_BOX (hbox21), table20, TRUE, TRUE, 3);
  ...
  gtk_table_attach (GTK_TABLE (table20), bg_match_mul_rb, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table20), bg_match_off_rb, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table20), bg_match_add_rb, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  label81 = gtk_label_new ("Stacking");
  gtk_widget_ref (label81);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "label81", label81,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "vbox23", vbox23,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox23);
  gtk_container_add (GTK_CONTAINER (notebook3), vbox23);

  table21 = gtk_table_new (3, 2, FALSE);
  gtk_widget_ref (table21);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "table21", table21,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table21);
  gtk_box_pack_start (GTK_BOX (vbox23), table21, FALSE, TRUE, 0);

  label85 = gtk_label_new ("Output file / dir name");
  gtk_widget_ref (label85);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "label85", label85,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label85);
  gtk_table_attach (GTK_TABLE (table21), label85, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table21), output_file_entry, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table21), output_file_browse, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_tooltips_set_tip (tooltips, output_file_browse, "Browse", NULL);

  overwrite_checkb = gtk_check_button_new_with_label ("Overwrite original files");
  gtk_widget_ref (overwrite_checkb);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "overwrite_checkb", overwrite_checkb,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_table_attach (GTK_TABLE (table21), overwrite_checkb, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_widget_set_sensitive (overwrite_checkb, FALSE);
  gtk_tooltips_set_tip (tooltips, overwrite_checkb, "Saveprocessed frames over the origianl ones", NULL);
  ...
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "hbuttonbox12", hbuttonbox12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbuttonbox12);
  gtk_box_pack_start (GTK_BOX (vbox23), hbuttonbox12, FALSE, TRUE, 0);

  run_button = gtk_button_new_with_label ("");
  run_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (run_button)->child),
                                   "_Run");
  gtk_widget_add_accelerator (run_button, "clicked", accel_group,
                              run_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (run_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "run_button", run_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (run_button);
  gtk_container_add (GTK_CONTAINER (hbuttonbox12), run_button);
  GTK_WIDGET_SET_FLAGS (run_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, run_button, "Run reduction process", NULL);

  abort_button = gtk_button_new_with_label ("");
  abort_button_key = gtk_label_parse_uline (GTK_LABEL (GTK_BIN (abort_button)->child),
                                   "_Abort");
  gtk_widget_add_accelerator (abort_button, "clicked", accel_group,
                              abort_button_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_ref (abort_button);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "abort_button", abort_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_container_add (GTK_CONTAINER (hbuttonbox12), abort_button);
  gtk_widget_set_sensitive (abort_button, FALSE);
  GTK_WIDGET_SET_FLAGS (abort_button, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, abort_button, "Stop reduction process", NULL);

  label84 = gtk_label_new ("Run");
  gtk_widget_ref (label84);
  gtk_object_set_data_full (GTK_OBJECT (image_processing), "label84", label84,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label84);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook3), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook3), 4), label84);

  gtk_object_set_data (GTK_OBJECT (image_processing), "tooltips", tooltips);

  gtk_window_add_accel_group (GTK_WINDOW (image_processing), accel_group);

  return image_processing;
}

GtkWidget*
create_obscript_stopped (void)
{
  GtkWidget *obscript_stopped;
  GtkWidget *vbox25;
  ...
  obscript_stopped = gtk_window_new (GTK_WINDOW_DIALOG);
  gtk_object_set_data (GTK_OBJECT (obscript_stopped), "obscript_stopped", obscript_stopped);
  gtk_window_set_title (GTK_WINDOW (obscript_stopped), "Obscript Stopped");
  gtk_window_set_position (GTK_WINDOW (obscript_stopped), GTK_WIN_POS_CENTER);
  gtk_window_set_default_size (GTK_WINDOW (obscript_stopped), 400, 300);

  vbox25 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox25);
  gtk_object_set_data_full (GTK_OBJECT (obscript_stopped), "vbox25", vbox25,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox25);
  gtk_container_add (GTK_CONTAINER (obscript_stopped), vbox25);

  drawing_area = gtk_drawing_area_new ();
  gtk_widget_ref (drawing_area);
  gtk_object_set_data_full (GTK_OBJECT (obscript_stopped), "drawing_area", drawing_area,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (drawing_area);
  gtk_box_pack_start (GTK_BOX (vbox25), drawing_area, TRUE, TRUE, 0);

  hseparator7 = gtk_hseparator_new ();
  gtk_widget_ref (hseparator7);
  gtk_object_set_data_full (GTK_OBJECT (obscript_stopped), "hseparator7", hseparator7,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hseparator7);
  gtk_box_pack_start (GTK_BOX (vbox25), hseparator7, FALSE, TRUE, 0);

  hbuttonbox14 = gtk_hbutton_box_new ();
  gtk_widget_ref (hbuttonbox14);
  gtk_object_set_data_full (GTK_OBJECT (obscript_stopped), "hbuttonbox14", hbuttonbox14,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbuttonbox14);
  gtk_box_pack_start (GTK_BOX (vbox25), hbuttonbox14, FALSE, FALSE, 0);

  close_button = gtk_button_new_with_label ("Close");
  gtk_widget_ref (close_button);
  gtk_object_set_data_full (GTK_OBJECT (obscript_stopped), "close_button", close_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (close_button);
  gtk_container_add (GTK_CONTAINER (hbuttonbox14), close_button);
  GTK_WIDGET_SET_FLAGS (close_button, GTK_CAN_DEFAULT);

  return obscript_stopped;
}
...
create_par_edit (void)
{
  ...
  par_edit = gtk_window_new (GTK_WINDOW_DIALOG);
...
create_entry_prompt (void)
{
  ...
  GTK_WINDOW (entry_prompt)->type = GTK_WINDOW_DIALOG;
...
create_guide_window (void)
{
  ...
  guide_run = gtk_button_new_with_label ("");
  ...
  guide_calibrate = gtk_button_new_with_label ("");
  ...
  gtk_object_set_data_full (GTK_OBJECT (guide_window), "hpaned2", hpaned2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hpaned2);
  gtk_box_pack_start (GTK_BOX (guide_vbox), hpaned2, FALSE, FALSE, 0);
  gtk_paned_set_position (GTK_PANED (hpaned2), 200);

  statusbar1 = gtk_statusbar_new ();
  gtk_widget_ref (statusbar1);
  gtk_object_set_data_full (GTK_OBJECT (guide_window), "statusbar1", statusbar1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (statusbar1);
  gtk_paned_pack1 (GTK_PANED (hpaned2), statusbar1, FALSE, TRUE);

  statusbar2 = gtk_statusbar_new ();
  gtk_widget_ref (statusbar2);
  gtk_object_set_data_full (GTK_OBJECT (guide_window), "statusbar2", statusbar2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (statusbar2);
  gtk_paned_pack2 (GTK_PANED (hpaned2), statusbar2, TRUE, TRUE);

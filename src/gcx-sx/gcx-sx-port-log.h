 ...
 * from the libgcx-sx framework. It is set using gp_log_add_func() and 
 * removed using gp_log_remove_func() and will then receive the logging
 * messages of the level specified.
 *
 * \param level the log level of the passed message, as set by the camera driver or libgcx-sx
 * \param domain the logging domain as set by the camera driver, or libgcx-sx function

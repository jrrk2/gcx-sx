...
"-p, --recipy <recipy_file>         Load recipy file (searches rcp_path)\n"
"-P, --phot-run <recipy_file>       Load recipy file and run photometry\n"
"                                     in batch mode. Report in native\n"
"                                     format.\n"
"-V, --phot-run-aavso <recipy_file> Load recipy file and run photometry\n"
...
"    --merge <recipy_file>          Merge a new recipy file over the one loaded\n"
"                                     with the --recipy option. Checks are made\n"
...
"                                     recipy file. It will also set the recipy\n" 
"                                     object, ra and dec fields.\n"
"    --make-tycho-rcp <radius>      Create a recipy file for the object specified\n"
"                                     with --object using tycho2 stars in a box\n"
"                                     radius arcminutes around the object\n"
//"    --convert-rcp <recipy_file>    Convert a recipy to the new format\n"
//"                                     If an output file name is not specified\n"
//"                                     (with the '-o' argument), stdout is used\n"
//"                                     If the file argument is '-', stdin is read\n"
"    --rcp-to-aavso <recipy_file>   Conevrt a recipy file to the aavso db\n"
"                                     (tab-delimited) format\n"
"                                     If the file argument is '-', stdin is read\n"
"                                     The recipy comment and star comment fields\n"
...
"goto             goto <objname> [<recipy>]\n"
"                   set observation target and slew telescope\n"
"                   also load the recipy file if present\n"
"match            match frame wcs and repoint telescope to center\n"
"                   the target object \n"
"phot             run the recipy file on the current frame\n"

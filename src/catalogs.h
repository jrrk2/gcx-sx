...
#define CPHOT_MASK 0x1ff00 /* mask for reduction flags */
...
//	void *catt;	/* the catalog */
	...
	void *data; /* placeholder for a pointer that is not handled in any way
		     * by the catalog/staredit code -- normally used to attach 
		     * photometry info */
};

...
#define ZP_FIT_NOCOLOR 3	/* the fit is valid, but didn't 
				 * include any color transformation */
#define ZP_FIT_OK 4		/* A complete fit, with transformation was done */
...
//	struct obs_data *obs;	/* the obs_data for the frame */
	...
	int band;		/* index for the observation's band 
